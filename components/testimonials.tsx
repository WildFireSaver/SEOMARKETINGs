...
const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "I was looking for a reliable solar contractor and this service made the process much easier. The consultation was thorough and professional - they took time to understand my needs and budget. I was pleasantly surprised to receive a $75 consultation fee, which showed they value my time. The contractor they matched me with provided excellent service and completed the installation on schedule.",
  ...
  },
  {
    ...
    quote:
      "Finding the right contractor for our kitchen renovation was challenging until we used this service. The consultation was detailed and honest - no pressure, just good advice about what would work best for our space and budget. The $85 consultation fee was a nice gesture that showed their professionalism. The contractor they recommended did beautiful work and we're very satisfied with the results.",
  ...
  },
  {
    ...
    quote:
      "After storm damage to our roof, I needed help finding a reliable contractor quickly. The consultation was comprehensive and they connected me with a licensed professional who handled the insurance coordination and completed high-quality work. The $90 consultation fee demonstrated their commitment to providing quality service. The process was smooth and stress-free.",
    projectType: "Roofing Services",
    projectValue: "$28,000",
    timeline: "2 weeks",
    rating: 5,
    consultationFee: 90,
  },
  {
    ...
    quote:
      "Our HVAC system needed replacement and I wasn't sure where to start. The consultation process was educational and professional. The $80 consultation fee showed they take the process seriously. The contractor they connected me with was knowledgeable and provided excellent service. The new system works perfectly and the installation was completed efficiently.",
