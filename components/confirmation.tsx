...
import { CheckCircle, Gift, CalendarDays, Phone } from "lucide-react"
    ...
    <div className="flex flex-1 items-center justify-center py-12 animate-fade-in">
      <Card className="w-full max-w-lg shadow-xl border-2 border-green-200">
        ...
        <CardContent className="p-6 space-y-6">
          <div className="text-center">
            <p className="text-gray-700">
              You're one step closer to your home improvement goals and your{" "}
              <strong className="text-primary">up to $100 cash reward!</strong>
            </p>
          </div>
        ...
        <CardFooter className="p-6 bg-gray-50 border-t">
          <Button onClick={handleGoHome} className="w-full bg-primary hover:bg-amber-600 text-lg py-3 h-auto">
            Back to Homepage
          </Button>
        </CardFooter>
      </Card>
